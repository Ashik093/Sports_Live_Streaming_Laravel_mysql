			  					...
			  					<div class="row">
			  						...
			  						<div class="col-md-6">
			  							...
			  							<div class="form-group">
			  								...
			  								<input type="text" name="team_one" id="team_one" class="form-control @error('team_one') is-invalid @enderror" placeholder="Enter Team One" value="{{ old('team_one') }}">
			  							</div>
			  							@error('team_one')
			  							...
			  							<div class="form-group">
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="time" id="time" class="form-control @error('time') is-invalid @enderror" placeholder="Enter Match Time" value="{{ old('time') }}">
			  							</div>
			  							@error('time')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			  							...
			  							@error('status')
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="channel_name" id="channel_name" class="form-control @error('channel_name') is-invalid @enderror" placeholder="Enter Channel Name" value="{{ old('channel_name') }}">
			  							</div>
			  							@error('channel_name')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			  						...
			  						<div class="col-md-6">
			  							...
			  							<div class="form-group">
			  								...
			  								<input type="text" name="team_two" id="team_two" class="form-control @error('team_two') is-invalid @enderror" placeholder="Enter Team Two" value="{{ old('team_two') }}">
			  							</div>
			  							@error('team_two')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			  							...
			  							@error('category_id')
				               	 		...
				               	 		<div class="form-group">
			  								...
			  								<textarea name="channel_link" id="channel_link" class="form-control @error('channel_link') is-invalid @enderror" >{{ old('channel_link') }}</textarea>
			  							</div>
			  							@error('channel_link')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			               	 			 <div class="form-group">
			  								<label>Score</label>
			  								<input type="text" name="score" id="score" class="form-control @error('score') is-invalid @enderror" placeholder="Enter Score (Optional)" value="{{ old('score') }}">
			  							</div>
			  							@error('score')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
